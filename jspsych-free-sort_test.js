...
jsPsych.plugins['free-sort'] = (function() {
  ...
  plugin.info = {
    ...
    parameters: {
      ...
      button_label: {
        ...
        default:  'Click when you are finished!',
  ...
  plugin.trial = function(display_element, trial) {
    ...
    for (var i = 0; i < trial.stimuli.length; i++) {
      var coords = get_coordinate(trial.sort_area_width - trial.stim_width, trial.sort_area_height - trial.stim_height);
      ...
      display_element.querySelector("#jspsych-free-sort-arena").innerHTML += '<img '+
        ...
        'draggable="false" '+
        'style="position: absolute; cursor: move; width:'+trial.stim_width+'px; height:'+trial.stim_height+'px; top:'+coords.y+'px; left:'+(coords.x+i*150)+'px;">'+
        '</img>';
  ...
  function get_coordinate(max_width, max_height) {
    var pos_x = 25;
    var pos_y = 450;
